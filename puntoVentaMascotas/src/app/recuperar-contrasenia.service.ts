...
export class RecuperarContraseniaService {
  ...
  public enviarCorreo(usuario: string) {
    ...
    this.http.get(`/usuariosWS/buscarUsuarioPorNombre/${usuario}`, { headers: this.headers }).subscribe(
      (success: any) => {
        ...
        this.http.post(`/loginWS/enviarEmail`, { emailUsuario, idUsuario }, { headers: this.headers }).subscribe(
          (success: any) => {
