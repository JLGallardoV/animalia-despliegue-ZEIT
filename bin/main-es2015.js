...
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
...
let AccesosComponent = class AccesosComponent {
    constructor(API, guardian) {
        this.API = API;
    ...
    //LISTAR ACCESOS
    listarAccesos() {
        this.API.mostrarAccesos().subscribe((success) => {
            this.dsAccesos = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
...
AccesosComponent.ctorParameters = () => [
...
AccesosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-accesos',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./accesos.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/accesos/accesos.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./accesos.component.scss */ "./src/app/accesos/accesos.component.scss")).default]
    })
], AccesosComponent);
...
let APIService = class APIService {
    ...
    aniadirAcceso(accionAcceso, idUsuario) {
    ...
    aniadirAlmacen(idAlmacen, estadoAlmacen, paisAlmacen, direccionAlmacen, referenciaAlmacen, telefonoAlmacen) {
    ...
    actualizarAlmacen(idAlmacen, estadoAlmacen, paisAlmacen, direccionAlmacen, referenciaAlmacen, telefonoAlmacen) {
    ...
    aniadirCategoria(nombreCategoria, subCategoria, descripcionCategoria) {
    ...
    actualizarCategoria(idCategoria, nombreCategoria, subCategoria, descripcionCategoria) {
    ...
    aniadirCliente(nombreCliente, apellidoPaternoCliente, apellidoMaternoCliente, ciudadCliente, estadoCliente, paisCliente, direccionCliente, coloniaCliente, cpCliente, telefonoCliente, emailCliente, idTipoCliente) {
    ...
    actualizarCliente(idCliente, nombreCliente, apellidoPaternoCliente, apellidoMaternoCliente, ciudadCliente, estadoCliente, paisCliente, direccionCliente, coloniaCliente, cpCliente, telefonoCliente, emailCliente, idTipoCliente) {
        let contraseniaCliente = null, puntuajeCliente = 0; //idea tienda online.
    ...
    aniadirCompra(idUsuario, idProveedor, montoCompra, productos) {
    ...
    aniadirCompensacion(tipoCompensacion, descripcionCompensacion) {
        return this.http.post('/compensacionesWS/agregarCompensacion', { tipoCompensacion, descripcionCompensacion }, { headers: this.headers });
    }
    actualizarCompensacion(idCompensacion, tipoCompensacion, descripcionCompensacion) {
    ...
    borrarCompensacion(idCompensacion) {
    ...
    mostrarDetalleDevolucion(idDevolucion) {
        return this.http.get(`/devolucionesWS/listarDetalleDevolucion/${idDevolucion}`, { headers: this.headers });
    }
    aniadirDevolucion(motivoDevolucion, idCliente, idTipoProblema, idProducto, idCompensacion, idTransaccion) {
    ...
    aniadirEnvio(ciudadEnvio, estadoEnvio, paisEnvio, observacionesEnvio, idTransaccion, idMedioEntrega) {
    ...
    aniadirProducto(nombreProducto, detalleProducto, contenidoProducto, fechaCaducidadProducto, paisOrigenProducto, stockProducto, precioUnitarioProducto, precioCompraProducto, idCategoria, idAlmacen) {
    ...
    actualizarProducto(idProducto, nombreProducto, detalleProducto, contenidoProducto, fechaCaducidadProducto, paisOrigenProducto, stockProducto, precioUnitarioProducto, precioCompraProducto, idCategoria, idAlmacen) {
    ...
    mostrarViabilidadProductos(fechaInicio, fechaFinal) {
    ...
    mostrarDetalleProveedor(idProveedor) {
        return this.http.get(`/proveedoresWS/listarDetalleProveedor/${idProveedor}`, { headers: this.headers });
    }
    aniadirProveedor(nombreProveedor, ciudadProveedor, estadoProveedor, paisProveedor, direccionProveedor, telefonoProveedor, emailProveedor, descripcionProveedor) {
    ...
    actualizarProveedor(idProveedor, nombreProveedor, ciudadProveedor, estadoProveedor, paisProveedor, direccionProveedor, telefonoProveedor, emailProveedor, descripcionProveedor) {
    ...
    mostrarReporte(fechaInicio, fechaFinal) {
    ...
    borrarTipoDeClientes(idTipoCliente) {
    ...
    borrarTipoDeUsuario(idTipoUsuario) {
    ...
    aniadirUsuario(nombreUsuario, emailUsuario, contraseniaUsuario, idVendedor, idTipoUsuario) {
    ...
    actualizarUsuario(idUsuario, nombreUsuario, emailUsuario, contraseniaUsuario, idVendedor, idTipoUsuario) {
    ...
    mostrarDetalleVendedor(idVendedor) {
        return this.http.get(`/vendedoresWS/listarDetalleVendedor/${idVendedor}`, { headers: this.headers });
    }
    aniadirVendedor(nombreVendedor, ciudadVendedor, estadoVendedor, direccionVendedor, telefonoVendedor, emailVendedor, fechaNacimientoVendedor, rfcVendedor, numeroSeguroSocialVendedor, antiguedadVendedor) {
    ...
    actualizarVendedor(idVendedor, nombreVendedor, ciudadVendedor, estadoVendedor, direccionVendedor, telefonoVendedor, emailVendedor, fechaNacimientoVendedor, rfcVendedor, numeroSeguroSocialVendedor, antiguedadVendedor) {
...
/* harmony import */ var _transacciones_transacciones_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transacciones/transacciones.component */ "./src/app/transacciones/transacciones.component.ts");
/* harmony import */ var _facturas_facturas_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./facturas/facturas.component */ "./src/app/facturas/facturas.component.ts");
/* harmony import */ var _devoluciones_devoluciones_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./devoluciones/devoluciones.component */ "./src/app/devoluciones/devoluciones.component.ts");
/* harmony import */ var _productos_productos_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./productos/productos.component */ "./src/app/productos/productos.component.ts");
...
/* harmony import */ var _herramientas_herramientas_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./herramientas/herramientas.component */ "./src/app/herramientas/herramientas.component.ts");
/* harmony import */ var _recuperar_contrasenia_recuperar_contrasenia_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./recuperar-contrasenia/recuperar-contrasenia.component */ "./src/app/recuperar-contrasenia/recuperar-contrasenia.component.ts");
...
const routes = [
    ...
    { path: 'recuperarContrasenia', component: _recuperar_contrasenia_recuperar_contrasenia_component__WEBPACK_IMPORTED_MODULE_12__["RecuperarContraseniaComponent"] },
    { path: 'transacciones', component: _transacciones_transacciones_component__WEBPACK_IMPORTED_MODULE_6__["TransaccionesComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'facturas', component: _facturas_facturas_component__WEBPACK_IMPORTED_MODULE_7__["FacturasComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'productos', component: _productos_productos_component__WEBPACK_IMPORTED_MODULE_9__["ProductosComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'devoluciones', component: _devoluciones_devoluciones_component__WEBPACK_IMPORTED_MODULE_8__["DevolucionesComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'usuarios', component: _usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_10__["UsuariosComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
    { path: 'herramientas', component: _herramientas_herramientas_component__WEBPACK_IMPORTED_MODULE_11__["HerramientasComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _funcionamiento_bitacora_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./funcionamiento-bitacora.service */ "./src/app/funcionamiento-bitacora.service.ts");
...
let AppComponent = AppComponent_1 = class AppComponent {
    ...
    denegarVistaMenu() {
        ...
        AppComponent_1.denegarModulosVendedores();
...
/* harmony import */ var _proveedores_proveedores_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./proveedores/proveedores.component */ "./src/app/proveedores/proveedores.component.ts");
...
/* harmony import */ var _transacciones_transacciones_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./transacciones/transacciones.component */ "./src/app/transacciones/transacciones.component.ts");
/* harmony import */ var _clientes_clientes_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./clientes/clientes.component */ "./src/app/clientes/clientes.component.ts");
/* harmony import */ var _facturas_facturas_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./facturas/facturas.component */ "./src/app/facturas/facturas.component.ts");
/* harmony import */ var _productos_productos_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./productos/productos.component */ "./src/app/productos/productos.component.ts");
/* harmony import */ var _devoluciones_devoluciones_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./devoluciones/devoluciones.component */ "./src/app/devoluciones/devoluciones.component.ts");
/* harmony import */ var _categorias_categorias_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./categorias/categorias.component */ "./src/app/categorias/categorias.component.ts");
/* harmony import */ var _vendedores_vendedores_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./vendedores/vendedores.component */ "./src/app/vendedores/vendedores.component.ts");
/* harmony import */ var _usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./usuarios/usuarios.component */ "./src/app/usuarios/usuarios.component.ts");
/* harmony import */ var _accesos_accesos_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./accesos/accesos.component */ "./src/app/accesos/accesos.component.ts");
/* harmony import */ var _herramientas_herramientas_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./herramientas/herramientas.component */ "./src/app/herramientas/herramientas.component.ts");
...
/* harmony import */ var _compras_compras_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./compras/compras.component */ "./src/app/compras/compras.component.ts");
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./auth.guard */ "./src/app/auth.guard.ts");
/* harmony import */ var _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./generar-pdfs.service */ "./src/app/generar-pdfs.service.ts");
/* harmony import */ var _recuperar_contrasenia_service__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./recuperar-contrasenia.service */ "./src/app/recuperar-contrasenia.service.ts");
/* harmony import */ var _confirmar_eliminar_service__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./confirmar-eliminar.service */ "./src/app/confirmar-eliminar.service.ts");
/* harmony import */ var _configuracion_configuracion_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./configuracion/configuracion.component */ "./src/app/configuracion/configuracion.component.ts");
/* harmony import */ var _recuperar_contrasenia_recuperar_contrasenia_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./recuperar-contrasenia/recuperar-contrasenia.component */ "./src/app/recuperar-contrasenia/recuperar-contrasenia.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        entryComponents: [],
        providers: [
            _auth_guard__WEBPACK_IMPORTED_MODULE_43__["AuthGuard"],
            { provide: _angular_material_core__WEBPACK_IMPORTED_MODULE_29__["MAT_DATE_LOCALE"], useValue: 'es-MX' },
            _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_44__["GenerarPDFsService"],
            _recuperar_contrasenia_service__WEBPACK_IMPORTED_MODULE_45__["RecuperarContraseniaService"],
            _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
            _confirmar_eliminar_service__WEBPACK_IMPORTED_MODULE_46__["ConfirmarEliminarService"]
        ],
...
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
/* harmony import */ var _confirmar_eliminar_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../confirmar-eliminar.service */ "./src/app/confirmar-eliminar.service.ts");
...
const etiquetaRango = (page, pageSize, length) => {
...
let CategoriasComponent = class CategoriasComponent {
    constructor(guardian, modalService, formBuilder, API, eliminacionSegura) {
        this.guardian = guardian;
    ...
    openAltaCategoria(contentCategoria) {
    ...
    openEditarCategoria(contentCategoria, idCategoria, nombreCategoria, subCategoria, descripcionCategoria) {
    ...
    //LISTAR CATEGORIAS
    listarCategorias() {
        this.API.mostrarCategorias().subscribe((success) => {
            ...
            this.dsCategorias = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    ejecutarPeticion() {
        ...
        if (this.titulo == "Agregar Categoria") {
            this.API.aniadirCategoria(nombreCategoriaForm, subCategoriaForm, descripcionCategoriaForm).subscribe((success) => {
        ...
        if (this.titulo == "Editar Categoria") {
            this.API.actualizarCategoria(idCategoriaForm, nombreCategoriaForm, subCategoriaForm, descripcionCategoriaForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarCategorias();
                this.frmCategorias.reset();
                this.modal.close();
    ...
    eliminarCategoria(idCategoria) {
        ...
        if (respuesta == true) {
            this.API.borrarCategoria(idCategoria).subscribe((success) => {
...
CategoriasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./categorias.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/categorias/categorias.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./categorias.component.scss */ "./src/app/categorias/categorias.component.scss")).default]
    })
], CategoriasComponent);
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../api.service */ "./src/app/api.service.ts");
/* harmony import */ var _date_format_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../date-format.service */ "./src/app/date-format.service.ts");
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
/* harmony import */ var _confirmar_eliminar_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../confirmar-eliminar.service */ "./src/app/confirmar-eliminar.service.ts");
/* harmony import */ var _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../generar-pdfs.service */ "./src/app/generar-pdfs.service.ts");
...
let ClientesComponent = class ClientesComponent {
    constructor(guardian, modalService, formBuilder, API, formateandoFecha, eliminacionSegura, PDF) {
        this.guardian = guardian;
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        this.API = API;
    ...
    //ABRIR MODAL CON LOS DATOS A EDITAR
    openEditar(content, idCliente, nombreCliente, apellidoPaternoCliente, apellidoMaternoCliente, ciudadCliente, estadoCliente, paisCliente, direccionCliente, coloniaCliente, cpCliente, telefonoCliente, emailCliente) {
        this.modal = this.modalService.open(content, { size: 'lg' });
    ...
    openScrollableContentCliente(longContentCliente, idCliente) {
        this.modalService.open(longContentCliente, { scrollable: true });
        this.listarDetalleCliente(idCliente);
    }
    //LISTAR CLIENTES
    listarClientes() {
        this.API.mostrarClientes().subscribe((success) => {
            this.dsClientes = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    listarDetalleCliente(idCliente) {
        this.API.mostrarDetalleCliente(idCliente).subscribe((success) => {
    ...
    ejecutarPeticion() {
        ...
        if (this.titulo == "Agregar Cliente") {
            this.API.aniadirCliente(nombreClienteForm, apellidoPaternoClienteForm, apellidoMaternoClienteForm, ciudadClienteForm, estadoClienteForm, paisClienteForm, direccionClienteForm, coloniaClienteForm, cpClienteForm, telefonoClienteForm, emailClienteForm, this.tipoCliente).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarClientes();
        ...
        if (this.titulo == "Editar Cliente") {
            this.API.actualizarCliente(idClienteForm, nombreClienteForm, apellidoPaternoClienteForm, apellidoMaternoClienteForm, ciudadClienteForm, estadoClienteForm, paisClienteForm, direccionClienteForm, coloniaClienteForm, cpClienteForm, telefonoClienteForm, emailClienteForm, this.tipoCliente).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarClientes();
                this.frmClientes.reset();
                this.modal.close();
    ...
    eliminarCliente(idCliente) {
        ...
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarCliente(idCliente).subscribe((success) => {
                alert(success.respuesta);
                this.listarClientes();
            }, (error) => {
                console.log("hubo un problema: ", error);
...
let ComprasComponent = class ComprasComponent {
    constructor(guardian, formBuilder, API) {
        this.guardian = guardian;
        this.formBuilder = formBuilder;
        this.API = API;
    ...
    listarProductos() {
        this.API.mostrarProductos().subscribe((success) => {
    ...
    listarProveedores() {
        this.API.mostrarProveedores().subscribe((success) => {
    ...
    mostrarUsuarioEnSesion() {
        this.API.buscarUsuarioPorNombre(localStorage.getItem("usuario")).subscribe((success) => {
    ...
    listarUsuarios() {
        this.API.mostrarUsuarios().subscribe((success) => {
    ...
    eliminarProductosCarrito(objetoProducto, indice) {
    ...
    agregarCompra() {
        ...
        let idUsuarioForm = 0, idProveedorForm = 0, montoCompraForm = 0;
        let arregloProductosForm = [];
        ...
        this.API.aniadirCompra(idUsuarioForm, idProveedorForm, montoCompraForm, arregloProductosForm).subscribe((success) => {
            if (success.estatus > 0) {
                alert(success.respuesta);
    ...
    listarUltimaCompra() {
        this.API.mostrarUltimaCompra().subscribe((success) => {
            //console.log("ultima compra: ",success.respuesta);
            let ultimaCompraRegistro = 0;
            ultimaCompraRegistro = success.respuesta[0].idCompra;
            this.API.mostrarDetalleCompra(ultimaCompraRegistro).subscribe((success) => {
                let arregloTemporalProductos = [];
                let productos = [];
...
ComprasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./compras.component.scss */ "./src/app/compras/compras.component.scss")).default]
    })
], ComprasComponent);
...
ConfiguracionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./configuracion.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/configuracion/configuracion.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./configuracion.component.scss */ "./src/app/configuracion/configuracion.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfirmarEliminarService", function() { return ConfirmarEliminarService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let ConfirmarEliminarService = class ConfirmarEliminarService {
    constructor() { }
...
ConfirmarEliminarService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
/* harmony import */ var _confirmar_eliminar_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../confirmar-eliminar.service */ "./src/app/confirmar-eliminar.service.ts");
/* harmony import */ var _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../generar-pdfs.service */ "./src/app/generar-pdfs.service.ts");
...
let DevolucionesComponent = class DevolucionesComponent {
    constructor(guardian, modalService, formBuilder, API, eliminacionSegura, PDF) {
        this.guardian = guardian;
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        this.API = API;
        ...
        this.titulo = ""; //para el modal
        this.formValid = false;
        this.arregloDetalleDevolucion = [];
        //propiedades para tabla
        this.displayedColumnsDevoluciones = [
            'idDevolucion',
            'nombreProducto',
            'nombreCliente',
            'tipoProblema',
        ...
        this.displayedColumnsTiposProblemas = [
            'idTipoProblema',
            'tipoProblema',
            'acciones'
        ];
        this.displayedColumnsCompensaciones = [
            'idCompensacion',
            'tipoCompensacion',
    ...
    openEditarTipoProblema(contentProblema, idTipoProblema, tipoProblema) {
    ...
    openEditarCompensacion(contentCompensacion, idCompensacion, tipoCompensacion, descripcionCompensacion) {
    ...
    openScrollableContentDevoluciones(longContentDevolucion, idDevolucion) {
        this.modalService.open(longContentDevolucion, { scrollable: true });
        this.listarDetalleDevolucion(idDevolucion);
    }
    //LISTADO DE REGISTROS
    listarDevoluciones() {
        this.API.mostrarDevoluciones().subscribe((success) => {
            //manipulamos esta variable para dar uso a un ngif que se uso en la vista en un label
            if (success.estatus > 0) {
            ...
            this.dsDevoluciones = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    listarDetalleDevolucion(idDevolucion) {
        this.API.mostrarDetalleDevolucion(idDevolucion).subscribe((success) => {
    ...
    listarTiposProblemas() {
        this.API.mostrarTiposDeProblemas().subscribe((success) => {
            //manipulamos esta variable para dar uso a un ngif que se uso en la vista en un label
            if (success.estatus > 0) {
            ...
            this.dsTiposProblemas = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    listarCompensaciones() {
        this.API.mostrarCompensaciones().subscribe((success) => {
            //manipulamos esta variable para dar uso a un ngif que se uso en la vista en un label
            if (success.estatus > 0) {
            ...
            this.dsCompensaciones = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    //para el select
    listarTransacciones() {
        this.API.mostrarTransacciones().subscribe((success) => {
    ...
    ejecutarPeticionDevolucion() {
        ...
        this.API.aniadirDevolucion(motivoDevolucionForm, idClienteForm, idTipoProblemaForm, idProductoForm, idCompensacionForm, idTransaccionForm).subscribe((success) => {
            alert(JSON.stringify(success.respuesta));
    ...
    ejecutarPeticionTipoProblema() {
        ...
        if (this.titulo == "Agregar Problema") {
            this.API.aniadirTipoDeProblema(tipoProblemaForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
        ...
        if (this.titulo == "Editar Problema") {
            this.API.actualizarTipoDeProblema(idTipoProblemaForm, tipoProblemaForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarTiposProblemas();
                this.frmTiposProblemas.reset();
                this.modal.close();
    ...
    ejecutarPeticionCompensacion() {
        ...
        if (this.titulo == "Agregar Compensacion") {
            this.API.aniadirCompensacion(tipoCompensacionForm, descripcionCompensacionForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
        ...
        if (this.titulo == "Editar Compensacion") {
            this.API.actualizarCompensacion(idCompensacionForm, tipoCompensacionForm, descripcionCompensacionForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarCompensaciones();
                this.frmCompensaciones.reset();
                this.modal.close();
    ...
    eliminarTipoProblema(idCliente) {
        let respuesta = false;
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarTipoDeProblema(idCliente).subscribe((success) => {
                alert(success.respuesta);
                this.listarTiposProblemas();
            }, (error) => {
                console.log("hubo un problema: ", error);
    ...
    eliminarCompensacion(idCliente) {
        let respuesta = false;
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarCompensacion(idCliente).subscribe((success) => {
                alert(success.respuesta);
                this.listarCompensaciones();
            }, (error) => {
                console.log("hubo un problema: ", error);
...
DevolucionesComponent.ctorParameters = () => [
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorDevoluciones', { static: true })
], DevolucionesComponent.prototype, "paginatorDevoluciones", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorTiposProblemas', { static: true })
], DevolucionesComponent.prototype, "paginatorTiposProblemas", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorCompensaciones', { static: true })
...
DevolucionesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./devoluciones.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/devoluciones/devoluciones.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./devoluciones.component.scss */ "./src/app/devoluciones/devoluciones.component.scss")).default]
    })
...
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/esm2015/table.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../api.service */ "./src/app/api.service.ts");
/* harmony import */ var _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../generar-pdfs.service */ "./src/app/generar-pdfs.service.ts");
...
let FacturasComponent = class FacturasComponent {
    constructor(formBuilder, API, PDF) {
        this.formBuilder = formBuilder;
        this.API = API;
        this.PDF = PDF;
    ...
    listarTiposDePagos() {
        this.API.mostrarTiposDePagos().subscribe((success) => {
    ...
    listarVendedores() {
        this.API.mostrarVendedores().subscribe((success) => {
    ...
    transfiereProductos() {
        let productoSeleccionado; //idProducto
        let cantidadSeleccionada = 0;
        this.API.mostrarProductos().subscribe((success) => {
    ...
    transfiereTiposDePagos(idTipoPago) {
        this.API.mostrarTiposDePagos().subscribe((success) => {
    ...
    agregarTransaccion() {
        let idClienteForm = 0, idVendedorForm = 0, pagoTransaccionForm = 0;
        let arregloProductosForm = [], arregloTiposDePagosForm = [];
        ...
        this.API.buscarTiposDePagosPorID(arregloTiposDePagosForm[0].idTipoPago).subscribe((success) => {
            if (success.respuesta[0].tipoPago != "efectivo") {
                pagoTransaccionForm = this.montoAcumulado;
                console.log("no pagaste en efectivo");
            }
            this.API.aniadirTransaccion(idClienteForm, idVendedorForm, pagoTransaccionForm, arregloProductosForm, arregloTiposDePagosForm).subscribe((success) => {
                if (success.estatus > 0) {
                    alert(success.respuesta);
    ...
    listarUltimaTransaccion() {
        this.API.mostrarUltimaTransaccion().subscribe((success) => {
            let idUltimaTransaccion = 0;
            idUltimaTransaccion = success.respuesta[0].idTransaccion;
            this.API.mostrarDetalleTransaccion(idUltimaTransaccion).subscribe((success) => {
                let arregloTemporalProductos = [];
                let productos = [];
                for (let i = 0; i < success.respuesta.length; i++) {
                    //atrapamos cada uno de los productos en un array
...
FacturasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./facturas.component.scss */ "./src/app/facturas/facturas.component.scss")).default]
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-compras',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../compras/compras.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/compras/compras.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../compras/compras.component.scss */ "./src/app/compras/compras.component.scss")).default]
    })
], FacturasComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuncionamientoBitacoraService", function() { return FuncionamientoBitacoraService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
let FuncionamientoBitacoraService = class FuncionamientoBitacoraService {
    constructor(http) {
        this.http = http;
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
    }
    ...
    agregarAcceso(accionAcceso, idUsuario) {
        console.log("accion: ", accionAcceso);
        this.http.post('/accesosWS/agregarAcceso', { accionAcceso, idUsuario }, { headers: this.headers }).subscribe((success) => {
    ...
    registrarAcceso(accion, nombreUsuario) {
        this.http.get(`/usuariosWS/buscarUsuarioPorNombre/${nombreUsuario}`, { headers: this.headers }).subscribe((success) => {
            let idCapturado = 0;
            let nivel = "";
...
FuncionamientoBitacoraService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
FuncionamientoBitacoraService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GenerarPDFsService", function() { return GenerarPDFsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let GenerarPDFsService = class GenerarPDFsService {
    constructor() {
    }
    generarPDF(etiquetaPDF) {
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_3___default()(data).then(canvas => {
            ...
            let pdf = new jspdf__WEBPACK_IMPORTED_MODULE_2__('p', 'mm', 'a4');
            var position = 7;
...
GenerarPDFsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], GenerarPDFsService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HerramientasComponent", function() { return HerramientasComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/esm2015/table.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api.service */ "./src/app/api.service.ts");
/* harmony import */ var _date_format_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../date-format.service */ "./src/app/date-format.service.ts");
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
...
let HerramientasComponent = class HerramientasComponent {
    constructor(guardian, modalService, formBuilder, API, formateandoFecha) {
        this.guardian = guardian;
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        this.API = API;
    ...
    generarUtilidad() {
        ...
        this.API.mostrarReporte(fechaInicioFormateada, fechaFinalFormateada).subscribe((success) => {
            ...
            let arregloReportesEconomicos = [{ montoTransacciones: valorTransacciones, montoCompras: valorCompras, utilidad: valorUtilidad }];
            this.dsReporteEconomico = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](arregloReportesEconomicos);
    ...
    mostrarVentasProductos() {
        ...
        let fechaInicioFormateada = this.formateandoFecha.formatearFecha(fechaInicioForm);
        let fechaFinalFormateada = this.formateandoFecha.formatearFecha(fechaFinalForm);
        this.API.mostrarViabilidadProductos(fechaInicioFormateada, fechaFinalFormateada).subscribe((success) => {
            if (success.estatus == 1) {
                this.dsViabilidadProductos = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    mostrarVentasVendedores() {
        ...
        let fechaInicioFormateada = this.formateandoFecha.formatearFecha(fechaInicioForm);
        let fechaFinalFormateada = this.formateandoFecha.formatearFecha(fechaFinalForm);
        this.API.mostrarRendimientoVendedores(fechaInicioFormateada, fechaFinalFormateada).subscribe((success) => {
            ...
            if (success.estatus == 1 && success.respuesta[0].nombreVendedor != null) {
                this.dsRendimientoVendedores = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    validarInputsFechaUtilidad(event) {
        let fechaMinima = "";
    ...
    validarInputsFechaProductos(event) {
        let fechaMinima = "";
    ...
    validarInputsFechaVendedores(event) {
        let fechaMinima = "";
...
HerramientasComponent.ctorParameters = () => [
    { type: _login_jwt_service__WEBPACK_IMPORTED_MODULE_7__["LoginJwtService"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] },
    { type: _api_service__WEBPACK_IMPORTED_MODULE_5__["APIService"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorReporteEconomico', { static: true })
], HerramientasComponent.prototype, "MatPaginatorReporteEconomico", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorVentasProducto', { static: true })
], HerramientasComponent.prototype, "MatPaginatorVentasProducto", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorVentasVendedores', { static: true })
], HerramientasComponent.prototype, "MatPaginatorVentasVendedores", void 0);
HerramientasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-herramientas',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./herramientas.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/herramientas/herramientas.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./herramientas.component.scss */ "./src/app/herramientas/herramientas.component.scss")).default]
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-accesos',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../accesos/accesos.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/accesos/accesos.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../accesos/accesos.component.scss */ "./src/app/accesos/accesos.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoginJwtService", function() { return LoginJwtService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _funcionamiento_bitacora_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./funcionamiento-bitacora.service */ "./src/app/funcionamiento-bitacora.service.ts");
...
let LoginJwtService = class LoginJwtService {
    constructor(http, router, bitacora, menu) {
        this.http = http;
        this.router = router;
        this.bitacora = bitacora;
        this.menu = menu;
    ...
    login(nombreUsuario, contraseniaUsuario) {
        let accion = "acceso";
        this.http.post('/loginWS/autenticarUsuarios', { nombreUsuario, contraseniaUsuario }, { headers: this.headers }).subscribe((resp) => {
            if (resp.estatus > 0) {
...
LoginJwtService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
LoginJwtService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], LoginJwtService);
...
/* harmony import */ var _recuperar_contrasenia_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../recuperar-contrasenia.service */ "./src/app/recuperar-contrasenia.service.ts");
 ...
 //invocaremos el metodo que cierra el login el cual se encuentra aquí

let LoginComponent = class LoginComponent {
    constructor(router, formBuilder, jwt, _snackBar, cerrarMenu, API) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.jwt = jwt;
...
let ProductosComponent = class ProductosComponent {
    ...
    //FUNCION PARA ABRIR EL MODAL, CONFIGURACIONES DE BOOTSTRAP
    openAltaProducto(contentProducto) {
        this.modal = this.modalService.open(contentProducto, { size: 'lg' });
        this.titulo = "Agregar Producto";
    }
    //ABRIR MODAL CON LOS DATOS A EDITAR
    openEditarProducto(contentProducto, idProducto, nombreProducto, detalleProducto, contenidoProducto, fechaCaducidadProducto, paisOrigenProducto, stockProducto, precioUnitarioProducto, precioCompraProducto, idCategoria, idAlmacen) {
    ...
    openScrollableContentProductos(longContentProductos, idProducto) {
    ...
    listarDetalleProducto(idProducto) {
        this.API.mostrarDetalleProducto(idProducto).subscribe((success) => {
    ...
    listarProductos() {
        this.API.mostrarProductos().subscribe((success) => {
            ...
            this.dsProductos = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    listarAlmacenes() {
        this.API.mostrarAlmacenes().subscribe((success) => {
    ...
    ejecutarPeticion() {
        ...
        if (this.titulo == "Agregar Producto") {
            this.API.aniadirProducto(nombreProductoForm, detalleProductoForm, contenidoProductoForm, fechaCaducidadProductoForm, paisOrigenProductoForm, stockProductoForm, precioUnitarioProductoForm, precioCompraProductoForm, idCategoriaForm, idAlmacenForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarProductos();
        ...
        if (this.titulo == "Editar Producto") {
            this.API.actualizarProducto(idProductoForm, nombreProductoForm, detalleProductoForm, contenidoProductoForm, fechaCaducidadProductoForm, paisOrigenProductoForm, stockProductoForm, precioUnitarioProductoForm, precioCompraProductoForm, idCategoriaForm, idAlmacenForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarProductos();
                this.frmProductos.reset();
                this.modal.close();
    ...
    eliminarProducto(idProducto) {
        ...
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarProducto(idProducto).subscribe((success) => {
                alert(success.respuesta);
                this.listarProductos();
            }, (error) => {
                console.log("hubo un problema: ", error);
    ...
    //INVOCANDO SERVICIO PARA GENERAR PDF
    generarPdfParticular(etiquetaPDF) {
        this.PDF.generarPDF(etiquetaPDF);
    }
...
ProductosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./productos.component.scss */ "./src/app/productos/productos.component.scss")).default]
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-categorias',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../categorias/categorias.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/categorias/categorias.component.html")).default
...
let ProveedoresComponent = class ProveedoresComponent {
    ...
    //ABRIR MODAL CON LOS DATOS A EDITAR
    openEditar(content, idProveedor, nombreProveedor, ciudadProveedor, estadoProveedor, paisProveedor, direccionProveedor, telefonoProveedor, emailProveedor, descripcionProveedor) {
    ...
    openScrollableContentProveedor(longContentProveedor, idProveedor) {
    ...
    listarProveedores() {
        this.API.mostrarProveedores().subscribe((success) => {
            this.dsProveedores = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    //LISTAR DETALLES PRODUCTOS
    listarDetalleProveedor(idProveedor) {
        this.API.mostrarDetalleProveedor(idProveedor).subscribe((success) => {
    ...
    ejecutarPeticion() {
        ...
        if (this.titulo == "Agregar Proveedor") {
            this.API.aniadirProveedor(nombreProveedorForm, ciudadProveedorForm, estadoProveedorForm, paisProveedorForm, direccionProveedorForm, telefonoProveedorForm, emailProveedorForm, descripcionProveedorForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarProveedores();
        ...
        if (this.titulo == "Editar Proveedor") {
            this.API.actualizarProveedor(idProveedorForm, nombreProveedorForm, ciudadProveedorForm, estadoProveedorForm, paisProveedorForm, direccionProveedorForm, telefonoProveedorForm, emailProveedorForm, descripcionProveedorForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarProveedores();
                this.frmProveedores.reset();
                this.modal.close();
    ...
    eliminarProveedor(idProveedor) {
        ...
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarProveedor(idProveedor).subscribe((success) => {
                alert(success.respuesta);
                this.listarProveedores();
            }, (error) => {
                console.log("hubo un problema: ", error);
...
ProveedoresComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./proveedores.component.scss */ "./src/app/proveedores/proveedores.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RecuperarContraseniaService", function() { return RecuperarContraseniaService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let RecuperarContraseniaService = class RecuperarContraseniaService {
    ...
    enviarCorreo(usuario) {
        ...
        this.http.get(`/usuariosWS/buscarUsuarioPorNombre/${usuario}`, { headers: this.headers }).subscribe((success) => {
            if (success.estatus == 0) {
            ...
            this.http.post(`/loginWS/enviarEmail`, { emailUsuario, idUsuario }, { headers: this.headers }).subscribe((success) => {
    ...
    verificarToken(jwt) {
        return this.http.post(`/loginWS/validarToken`, { jwt }, { headers: this.headers });
    }
    //ACTUALIZA LA CONTRASEÑA
    sustituirContrasenia(idUsuario, contraseniaUsuario) {
        console.log("usuario en api: ", idUsuario);
        return this.http.post(`/loginWS/nuevaContrasenia`, { idUsuario, contraseniaUsuario }, { headers: this.headers });
    }
};
RecuperarContraseniaService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
RecuperarContraseniaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _recuperar_contrasenia_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../recuperar-contrasenia.service */ "./src/app/recuperar-contrasenia.service.ts");
...
let RecuperarContraseniaComponent = class RecuperarContraseniaComponent {
    constructor(actRoute, router, formBuilder, API) {
        this.actRoute = actRoute;
        this.router = router;
        this.formBuilder = formBuilder;
        this.API = API;
    ...
    obtenerToken() {
        this.actRoute.queryParams.subscribe((params) => {
            ...
            this.API.verificarToken(token).subscribe((success) => {
                if (success.estatus != 1) {
                    this.router.navigate(['/login']);
                    setTimeout(() => {
                        alert(success.respuesta);
    ...
    actualizarContrasenia() {
        this.actRoute.queryParams.subscribe((params) => {
            ...
            this.API.sustituirContrasenia(idUsuario, Object(js_sha256__WEBPACK_IMPORTED_MODULE_5__["sha256"])(nuevaContrasenia)).subscribe((success) => {
                if (success.estatus == 1) {
                    alert(success.respuesta);
                    setTimeout(() => {
                        this.router.navigate(['/login']);
...
RecuperarContraseniaComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] },
    { type: _recuperar_contrasenia_service__WEBPACK_IMPORTED_MODULE_4__["RecuperarContraseniaService"] }
];
RecuperarContraseniaComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-recuperar-contrasenia',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./recuperar-contrasenia.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/recuperar-contrasenia/recuperar-contrasenia.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./recuperar-contrasenia.component.scss */ "./src/app/recuperar-contrasenia/recuperar-contrasenia.component.scss")).default]
    })
], RecuperarContraseniaComponent);
...
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../api.service */ "./src/app/api.service.ts");
/* harmony import */ var _login_jwt_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../login-jwt.service */ "./src/app/login-jwt.service.ts");
/* harmony import */ var _generar_pdfs_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../generar-pdfs.service */ "./src/app/generar-pdfs.service.ts");
...
let TransaccionesComponent = class TransaccionesComponent {
    constructor(guardian, modalService, API, PDF) {
        this.guardian = guardian;
        this.modalService = modalService;
        this.API = API;
        this.PDF = PDF;
    ...
    */
    ...
    listarTransacciones() {
        this.API.mostrarTransacciones().subscribe((success) => {
            ...
            this.dsTransacciones = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    listarDetalleTransaccion(idTransaccion) {
        this.API.mostrarDetalleTransaccion(idTransaccion).subscribe((success) => {
            let arregloTemporalProductos = [];
            let productos = [];
            for (let i = 0; i < success.respuesta.length; i++) {
                //atrapamos cada uno de los productos en un array
    ...
    //LISTAR COMPRAS
    listarCompras() {
        this.API.mostrarCompras().subscribe((success) => {
            if (success.estatus > 0) {
            ...
            this.dsCompras = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](success.respuesta);
    ...
    listarDetalleCompra(idCompra) {
        this.API.mostrarDetalleCompra(idCompra).subscribe((success) => {
            let arregloTemporalProductos = [];
            let productos = [];
            for (let i = 0; i < success.respuesta.length; i++) {
                //atrapamos cada uno de los productos en un array
    ...
    openScrollableContentVentas(longContentVentas, idVenta) {
    ...
    openScrollableContentCompras(longContentCompras, idCompra) {
...
TransaccionesComponent.ctorParameters = () => [
    { type: _login_jwt_service__WEBPACK_IMPORTED_MODULE_5__["LoginJwtService"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
    { type: _api_service__WEBPACK_IMPORTED_MODULE_4__["APIService"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorCompras', { static: true })
], TransaccionesComponent.prototype, "paginatorCompras", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('MatPaginatorTransacciones', { static: true })
], TransaccionesComponent.prototype, "paginatorTransacciones", void 0);
TransaccionesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-transacciones',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./transacciones.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/transacciones/transacciones.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./transacciones.component.scss */ "./src/app/transacciones/transacciones.component.scss")).default]
    })
...
let UsuariosComponent = class UsuariosComponent {
    ...
    //ABRIR MODAL CON LOS DATOS A EDITAR
    openEditar(content, idUsuario, nombreUsuario, emailUsuario, idVendedor, idTipoUsuario) {
    ...
    listarUsuarios() {
        this.API.mostrarUsuarios().subscribe((success) => {
            ...
            this.dsUsuarios = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    listarTiposDeUsuarios() {
        this.API.mostrarTiposDeUsuarios().subscribe((success) => {
    ...
    ejecutarPeticion() {
        ...
        let contraseniaEncriptada = Object(js_sha256__WEBPACK_IMPORTED_MODULE_8__["sha256"])(contraseniaUsuarioForm); //Encriptacion de constraña sha256
        if (this.titulo == "Agregar Usuario") {
            this.API.aniadirUsuario(nombreUsuarioForm, emailUsuarioForm, contraseniaEncriptada, idVendedorForm, idTipoUsuarioForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarUsuarios();
        ...
        if (this.titulo == "Editar Usuario") {
            this.API.actualizarUsuario(idUsuarioForm, nombreUsuarioForm, emailUsuarioForm, contraseniaUsuarioForm, idVendedorForm, idTipoUsuarioForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarUsuarios();
                this.frmUsuarios.reset();
                this.modal.close();
    ...
    eliminarUsuario(idUsuario) {
        ...
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarUsuario(idUsuario).subscribe((success) => {
                alert(success.respuesta);
                this.listarUsuarios();
            }, (error) => {
                console.log("hubo un problema: ", error);
...
UsuariosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./usuarios.component.scss */ "./src/app/usuarios/usuarios.component.scss")).default]
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-clientes',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../clientes/clientes.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/clientes/clientes.component.html")).default,
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-vendedores',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../vendedores/vendedores.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/vendedores/vendedores.component.html")).default,
    }),
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-proveedores',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!../proveedores/proveedores.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/proveedores/proveedores.component.html")).default,
    })
], UsuariosComponent);
...
let VendedoresComponent = class VendedoresComponent {
    constructor(guardian, modalService, formBuilder, API, formateandoFecha, eliminacionSegura, PDF) {
        this.guardian = guardian;
        this.modalService = modalService;
        this.formBuilder = formBuilder;
    ...
    //ABRIR MODAL CON LOS DATOS A EDITAR
    openEditar(content, idVendedor, nombreVendedor, ciudadVendedor, estadoVendedor, direccionVendedor, telefonoVendedor, emailVendedor, fechaNacimientoVendedor, rfcVendedor, numeroSeguroSocialVendedor, antiguedadVendedor) {
    ...
    openScrollableContentVendedor(longContentVendedor, idVendedor) {
    ...
    listarVendedores() {
        this.API.mostrarVendedores().subscribe((success) => {
            this.dsVendedores = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](success.respuesta);
    ...
    //LISTAR DETALLES CLIENTES
    listarDetalleVendedor(idCliente) {
        this.API.mostrarDetalleVendedor(idCliente).subscribe((success) => {
    ...
    ejecutarPeticion() {
        ...
        if (this.titulo == "Agregar Vendedor") {
            this.API.aniadirVendedor(nombreVendedorForm, ciudadVendedorForm, estadoVendedorForm, direccionVendedorForm, telefonoVendedorForm, emailVendedorForm, fechaNacimientoVendedorFormateada, rfcVendedorForm, numeroSeguroSocialVendedorForm, antiguedadVendedorForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarVendedores();
        ...
        if (this.titulo == "Editar Vendedor") {
            this.API.actualizarVendedor(idVendedorForm, nombreVendedorForm, ciudadVendedorForm, estadoVendedorForm, direccionVendedorForm, telefonoVendedorForm, emailVendedorForm, fechaNacimientoVendedorFormateada, rfcVendedorForm, numeroSeguroSocialVendedorForm, antiguedadVendedorForm).subscribe((success) => {
                alert(JSON.stringify(success.respuesta));
                this.listarVendedores();
                this.frmVendedores.reset();
                this.modal.close();
    ...
    eliminarVendedor(idVendedor) {
        ...
        respuesta = this.eliminacionSegura.confirmarEliminacion();
        if (respuesta == true) {
            this.API.borrarVendedor(idVendedor).subscribe((success) => {
                alert(success.respuesta);
                this.listarVendedores();
            }, (error) => {
                console.log("hubo un problema: ", error);
...
VendedoresComponent.ctorParameters = () => [
    { type: _login_jwt_service__WEBPACK_IMPORTED_MODULE_8__["LoginJwtService"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _api_service__WEBPACK_IMPORTED_MODULE_6__["APIService"] },
...
VendedoresComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-vendedores',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./vendedores.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/vendedores/vendedores.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./vendedores.component.scss */ "./src/app/vendedores/vendedores.component.scss")).default]
    })
], VendedoresComponent);
...
module.exports = __webpack_require__(/*! /home/jlgallardov/Documents/Trabajos/GRUPO 375/TIENDA MASCOTAS/deployAnimalia/puntoVentaMascotas/src/main.ts */"./src/main.ts");
